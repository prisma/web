# Shared conventions for the C21 plain-language pass (carried from the fundamentals and reference sections)

Verified facts (rc.10 source at wip/prisma-src/, commit cfccb09be2). Use these words on every page; do not restate them differently.
