...
When supplying a `DATABASE_URL` yourself, point it at the database for that environment. Prisma's [branching documentation](https://www.prisma.io/docs/compute/branching) covers that configuration. Separate branch databases aren't automatically populated with production data.
