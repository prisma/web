...
metaImagePath: "/backend-prisma-typescript-orm-with-postgresql-auth-mngp1ps7kip4/imgs/meta.png"
heroImagePath: "/backend-prisma-typescript-orm-with-postgresql-auth-mngp1ps7kip4/imgs/hero.svg"
heroImageAlt: "A three-step flow on light paper: POST /login takes the user's email, an 8-digit token expires in 10 minutes, and /authenticate exchanges it for a JWT valid for 12 hours, drawn as the highlighted card."
