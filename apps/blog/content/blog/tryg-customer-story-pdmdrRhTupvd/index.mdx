...
metaImagePath: "/tryg-customer-story-pdmdrRhTupvd/imgs/meta.png"
heroImagePath: "/tryg-customer-story-pdmdrRhTupvd/imgs/hero.svg"
heroImageAlt: "A merge diagram under the words 'Many sources, one data model': five hairline streams labelled 'Billions of records' converge into a cyan card reading 'Canonical model / schema.prisma', which feeds one arrow into a card reading 'GraphQL API / generated resolvers'."
tags:
  - "case-study"
---
