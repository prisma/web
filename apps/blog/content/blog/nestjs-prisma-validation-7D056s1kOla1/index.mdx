...
### Does `whitelist: true` reject requests that contain unknown fields?
...
### Do I need both `class-validator` and `class-transformer`?
...
### How do I validate URL path parameters like `/articles/:id`?
