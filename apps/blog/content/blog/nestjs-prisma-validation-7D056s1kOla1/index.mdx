...
metaImagePath: "/nestjs-prisma-validation-7D056s1kOla1/imgs/meta.png"
heroImagePath: "/nestjs-prisma-validation-7D056s1kOla1/imgs/hero.svg"
heroImageAlt: "A branching diagram on light paper: a POST /articles request enters a highlighted ValidationPipe node, which forks along a cyan arrow to a route handler and along a grey arrow to 400 Bad Request, under the headline “Validate before the handler”."
