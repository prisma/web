...
metaImagePath: "/improving-query-performance-using-indexes-3-kduk351qv1/imgs/meta.png"
heroImagePath: "/improving-query-performance-using-indexes-3-kduk351qv1/imgs/hero.svg"
heroImageAlt: "A diagram on light paper in which the value 'Wick' passes through hash() and a yellow arrow lands in a single lit bucket among eight, labelled 1.6 ms, above the schema line @@index([lastName], type: Hash)."
