...
Any client connected to the Prisma MCP server, including Claude Code, Cursor, VS Code, Windsurf, and the Vercel MCP integration.

**Do I need to set anything up?**
No. If you can already create a database through the Prisma MCP server, docs search is there too, with no extra auth or config.

**Can it change my database?**
No. `search_prisma_documentation` is read-only. It answers questions and never runs SQL or modifies anything.
