...
metaImagePath: "/how-bucket-uses-prisma-orm/imgs/meta.png"
heroImagePath: "/how-bucket-uses-prisma-orm/imgs/hero.svg"
heroImageAlt: "A three-step flow on light paper - define the models, run one migration, tables ready - the path Bucket follows to add new tables with Prisma ORM."
tags:
  - "case-study"
  - "orm"
---
