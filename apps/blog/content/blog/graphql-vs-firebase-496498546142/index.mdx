...
heroImageAlt: "An indented ladder of bars standing for Firebase's single JSON tree, beside a small graph of connected typed nodes standing for a GraphQL schema."
---
