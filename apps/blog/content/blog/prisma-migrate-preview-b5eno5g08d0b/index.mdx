...
metaImagePath: "/prisma-migrate-preview-b5eno5g08d0b/imgs/meta.png"
heroImagePath: "/prisma-migrate-preview-b5eno5g08d0b/imgs/hero.svg"
heroImageAlt: "A three-row ledger of the Preview workflow: create the migration SQL without applying it, edit migration.sql in a highlighted cyan row, then apply it and generate Prisma Client."
---
