...
metaDescription: "How to combine agents and infrastructure without burning down your servers"
tags:
  - "ai"
  - "infrastructure"
---
...
More spinning. Imagine creating persistent hosts in 2026. Imagine defining what Claude has started calling a "substrate" without Terraform or Kubernetes. _[NixOS](https://nixos.org) and [Guix](https://guix.gnu.org/) are the only tools that meet your constraints of declarative, reproducible systems that apply updates without a system reboot and are not based on proprietary tech._ Good bot.
