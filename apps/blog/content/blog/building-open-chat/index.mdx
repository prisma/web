...
excerpt: "How I built Open Chat — durable, resumable AI chat where the answer is safe the instant it exists — on Durable Streams, Prisma Streams, TanStack DB, and Prisma Compute."
