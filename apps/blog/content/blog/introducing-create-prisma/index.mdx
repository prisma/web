...
You know what you want to build. You pick a framework and a database. But before you can work on the app itself, you still need to set up Prisma, add a schema, add database scripts, create a seed file, set `DATABASE_URL`, generate Prisma Client, and run a migration.
...
You can find the project on GitHub at [github.com/prisma/create-prisma](https://github.com/prisma/create-prisma).
