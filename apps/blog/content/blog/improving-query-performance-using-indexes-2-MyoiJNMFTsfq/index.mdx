...
metaImagePath: "/improving-query-performance-using-indexes-2-MyoiJNMFTsfq/imgs/meta.png"
heroImagePath: "/improving-query-performance-using-indexes-2-MyoiJNMFTsfq/imgs/hero.svg"
heroImageAlt: "A dark code card on a light background showing a Prisma schema User model with the line @@index([firstName]) highlighted in yellow, beside an execution time falling from a struck-through 66.5 ms to 0.8 ms."
