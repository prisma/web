...
To ensure developers using Prisma ORM are making their queries as fast as possible, we recently launched [Prisma Optimize](https://www.prisma.io) — a tool that analyzes the queries you send to your database with Prisma ORM and gives you insights and recommendations for how to improve them.
