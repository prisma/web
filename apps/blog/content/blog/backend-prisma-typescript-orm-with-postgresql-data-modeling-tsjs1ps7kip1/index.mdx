...
metaImagePath: "/backend-prisma-typescript-orm-with-postgresql-data-modeling-tsjs1ps7kip1/imgs/meta.png"
heroImagePath: "/backend-prisma-typescript-orm-with-postgresql-data-modeling-tsjs1ps7kip1/imgs/hero.svg"
heroImageAlt: "A relation diagram from the grading-system data model: User and Course on either side of a highlighted CourseEnrollment relation table holding the userId and courseId foreign keys, captioned \"One m-n relation, two 1-n relations\"."
