...
- **[Prisma 8](https://www.prisma.io/docs/orm/next)** (Early Access) provides the migration toolchain in the examples, via the `prisma-next` CLI. The same workflow also works with Prisma 7's `prisma migrate deploy`.
