...
| --- | --- | --: | --: |
| Compute | Tigris | 60.2 | 81.3 |
| Compute | R2 | 17.7 | 24.9 |
| Compute | S3 | 91.1 | 83.4 |
| Compute | S3 Express | 76.4 | 71.9 |
| Lambda | Tigris | 46.1 | 65.8 |
| Lambda | R2 | 16.6 | 23.1 |
| Lambda | S3 | 62.6 | 73.0 |
| Lambda | S3 Express | 64.2 | 98.8 |

None of this changes the verdict for `accelerated-fs`: that workload is thousands of small operations, where latency rules and Tigris wins. Bulk transfer is simply a different regime — and one where, if it were our main workload, S3 would be the obvious pick, both the fastest and the steadiest of the four.
