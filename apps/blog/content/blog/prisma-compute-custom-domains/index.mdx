...
Generated URLs are useful for quick testing and some personal app scenarios, but they have limits. You may need to receive webhooks from another service. You may want to send a link to a friend or teammate. You may want the domain to match the project instead of the platform that hosts it. That expectation shows up early, even for prototypes, demos, internal tools, and weekend projects. The moment an app becomes something other people interact with, the URL starts to matter.
...
1. Add a custom domain to a Prisma Compute service through the API or Prisma Console.
2. Create the CNAME record Prisma Compute gives you.
...
You bring the domain. Prisma Compute handles the pieces needed to make that domain usable with your deployment.
