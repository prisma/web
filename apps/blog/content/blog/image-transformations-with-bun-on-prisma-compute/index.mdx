...
Prisma Compute runs on Bun, so you get Bun's [native image transformations](https://bun.com/docs/runtime/image) for free, with no external service to manage.
