...
metaImagePath: "/learn-typescript-a-pocketguide-tutorial-q329XmXQHUjz/imgs/meta.png"
heroImagePath: "/learn-typescript-a-pocketguide-tutorial-q329XmXQHUjz/imgs/hero.svg"
heroImageAlt: "A dark code card showing the getWordLength example with its string and number type annotations picked out in yellow above the type error that calling it with 42 produces."
---
