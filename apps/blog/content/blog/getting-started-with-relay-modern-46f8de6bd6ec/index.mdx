...
metaImagePath: "/getting-started-with-relay-modern-46f8de6bd6ec/imgs/meta.png"
heroImagePath: "/getting-started-with-relay-modern-46f8de6bd6ec/imgs/hero.svg"
heroImageAlt: "A dark code card holding the tutorial's GraphQL fragment Post_post on Post with the fields id, description and imageUrl."
---
