...
metaImagePath: "/datamodel-v11-lrzqy1f56c90/imgs/meta.png"
heroImagePath: "/datamodel-v11-lrzqy1f56c90/imgs/hero.svg"
heroImageAlt: "An ink code card showing the datamodel v1.1 syntax, with the @db directives that map the User model to a user table and the name field to a full_name column highlighted."
---
