---
title: "Prisma Next Performance Benchmarks: Reaching 87% of Raw pg Throughput"
slug: "prisma-next-performance-benchmark"
date: "2026-06-11"
authors:
  - "Serhii Tatarintsev"
metaTitle: "Prisma Next Performance Benchmarks: Reaching 87% of Raw pg Throughput"
metaDescription: "Prisma Next performance benchmarks achieves about 87% of the raw pg driver's peak throughput, holds latency low under load, and ships as a 148.5 KB gzipped bundle for serverless and edge workloads."
...
It's bundle size gzipped is about **148.5 KB** gzipped, compared to **1.32 MB** for Prisma 7, also about **9× smaller** to ship, which matters for serverless and edge deployments where bundle size drives cold starts. We look at that below.
