...
That rebuild is [Prisma 8](https://pris.ly/pn-series), the new foundation for Prisma ORM. It's written in TypeScript end to end and runs on a much lighter core, while keeping the same [model-first, type-safe workflow](https://www.prisma.io/docs/orm/next) you already use.
...
One note before the numbers: **Prisma 7 is still the version to use in production today.** [Prisma 8 is in Early Access](https://pris.ly/pn-ea), and once it's Generally Available you'll be able to run it in production too.
