...
Following our previous updates, we're excited to release the new, _Rust-free_ architecture in [Early Access](https://www.prisma.io/docs/orm/v7/more/releases#early-access) for PostgreSQL and SQLite with this week's [v6.7.0](http://github.com/prisma/prisma/releases/6.7.0) release. Please try it out and let us know what you think! 
