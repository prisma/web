...
metaImagePath: "/from-rust-to-typescript-a-new-chapter-for-prisma-orm/imgs/meta.png"
heroImagePath: "/from-rust-to-typescript-a-new-chapter-for-prisma-orm/imgs/hero.svg"
heroImageAlt: "A struck-through 14 MB for the Rust query engine above a large 1.6 MB for the new TypeScript query compiler."
...
If you're planning to adopt the new architecture, explore [Prisma ORM](https://www.prisma.io/orm), review the [Rust-free Prisma Client docs](https://www.prisma.io/docs/orm/prisma-client/setup-and-configuration/no-rust-engine), and use [Prisma Postgres](https://www.prisma.io/postgres) if you want the database workflow shown throughout this migration series.
