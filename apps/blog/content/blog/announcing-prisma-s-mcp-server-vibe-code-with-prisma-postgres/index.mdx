...
heroImageAlt: "An ink code card holding the mcpServers configuration that registers Prisma's MCP server, with the npx prisma mcp arguments highlighted in Postgres yellow."
---
