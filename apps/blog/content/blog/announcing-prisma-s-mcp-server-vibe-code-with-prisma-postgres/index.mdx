...
metaImagePath: "/announcing-prisma-s-mcp-server-vibe-code-with-prisma-postgres/imgs/meta.png"
heroImagePath: "/announcing-prisma-s-mcp-server-vibe-code-with-prisma-postgres/imgs/hero.svg"
heroImageAlt: "A soft yellow mesh field on light paper carrying the command npx prisma init --vibe 'Cat meme generator' in one small white card, under the line that your AI tool provisions the database."
---
