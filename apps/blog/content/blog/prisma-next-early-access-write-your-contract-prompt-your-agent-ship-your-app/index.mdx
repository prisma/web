...
[Prisma Next rethinks migration history](https://blog.prisma.io/blog/rethinking-database-migrations), the same way git treats code history: each migration moves your contract from one state to the next, just like each commit moves your code from one state to the next.
