...
**Prisma Next gives you superpowers and makes them safe to delegate to your agent, leaving you to focus on what matters: your app.** Define your data layer as a contract and the framework handles everything else for you: migrating your DB, type-checking your queries, meaningful errors when something goes wrong.
...
## One-line setup and onboarding. No ramp-up.
...
You can quickly setup Prisma Next along with the skills and template of your choice by running:
...
Imagine this to be your data contract:
...
<div style={{ position: "relative", width: "100%", aspectRatio: "16 / 9" }}>
  <iframe
    src="https://www.youtube.com/embed/0pvlcmFnWSI?autoplay=1&mute=1&loop=1&playlist=0pvlcmFnWSI&controls=0&modestbranding=1&rel=0&showinfo=0&disablekb=1&fs=0&iv_load_policy=3&playsinline=1"
...
<div style={{ position: "relative", width: "100%", aspectRatio: "16 / 9" }}>
  <iframe
    src="https://www.youtube.com/embed/C6exOjUIgBo?autoplay=1&mute=1&loop=1&playlist=C6exOjUIgBo&controls=0&modestbranding=1&rel=0&showinfo=0&disablekb=1&fs=0&iv_load_policy=3&playsinline=1"
...
<div style={{ position: "relative", width: "100%", aspectRatio: "16 / 9" }}>
  <iframe
    src="https://www.youtube.com/embed/2hPXEmALezI?autoplay=1&mute=1&loop=1&playlist=2hPXEmALezI&controls=0&modestbranding=1&rel=0&showinfo=0&disablekb=1&fs=0&iv_load_policy=3&playsinline=1"
...
<div style={{ position: "relative", width: "100%", aspectRatio: "16 / 9" }}>
  <iframe
    src="https://www.youtube.com/embed/znI2RiXJtRc?autoplay=1&mute=1&loop=1&playlist=znI2RiXJtRc&controls=0&modestbranding=1&rel=0&showinfo=0&disablekb=1&fs=0&iv_load_policy=3&playsinline=1"
