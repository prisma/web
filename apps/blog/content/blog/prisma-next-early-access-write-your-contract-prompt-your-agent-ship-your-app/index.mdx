...
If you've ever deployed an app, you've worked with [migrations](https://www.prisma.io/docs/orm/v8/migrations/how-migrations-work). Migrations are _one of the most painful parts_ of working with a database.
