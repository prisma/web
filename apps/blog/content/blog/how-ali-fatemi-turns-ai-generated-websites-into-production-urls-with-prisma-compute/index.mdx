---
title: "How Ali Fatemi Turns AI-Generated Websites into Production URLs with Prisma Compute"
slug: "how-ali-fatemi-turns-ai-generated-websites-into-production-urls-with-prisma-compute"
date: "2026-07-01"
authors:
  - "Gregory Boch"
metaTitle: "AI-Generated Websites to Production URLs with Prisma Compute"
metaDescription: "Ali Fatemi gave Claude the Prisma docs and CLI, then used Prisma Compute to turn AI-generated websites into working production URLs."
heroImagePath: "/how-ali-fatemi-turns-ai-generated-websites-into-production-urls-with-prisma-compute/imgs/hero.svg"
heroImageAlt: "A workflow showing Claude and the Prisma CLI deploying AI-generated websites to Prisma Compute and a production URL."
metaImagePath: "/how-ali-fatemi-turns-ai-generated-websites-into-production-urls-with-prisma-compute/imgs/meta.png"
...
Ali Fatemi is building an AI outreach system that does more than write emails.

It finds businesses in a target market, checks whether their website exists or needs work, researches the business, generates a custom site, asks Ali for approval, deploys it, and prepares the email with the live URL.

In one test, Ali left the system running overnight. By morning, it had generated roughly 50 websites for spas in Vancouver.
...
Seeing how easy it was to deploy and get a working URL... it was easier than Railway too.
</Quotes>

That is the story: AI can make software feel cheap to create, but it still needs a fast path to production.
...
![Claude, Prisma CLI, Prisma Compute, and production URL in one deployment loop](/how-ali-fatemi-turns-ai-generated-websites-into-production-urls-with-prisma-compute/imgs/agent-loop.svg)
...
Ali compared the setup to the other paths he had used. A VPS takes time to configure. Railway was familiar, but Prisma felt faster for this specific loop.
...
Prisma Compute sits in that handoff: from generated code to a working URL.

**Building with AI agents?** [Deploy your next TypeScript app with Prisma Compute](/blog/launching-prisma-compute-public-beta), or start from the [Compute quickstart](https://docs.prisma.io/docs/compute) and give your agent the CLI.
