...
metaImagePath: "/serverless-database-drivers-KML1ehXORxZV/imgs/meta.png"
heroImagePath: "/serverless-database-drivers-KML1ehXORxZV/imgs/hero.svg"
heroImageAlt: "A three-node flow running from Prisma Client through a driver adapter to Neon and PlanetScale, with the final hop labelled HTTP / WebSocket."
tags:
  - "orm"
  - "announcement"
---
