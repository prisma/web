...
During our recent [Enterprise Event](https://www.prisma.io) and a [Prisma Meetup](https://youtu.be/2g525rJdYFU?t=64), we started sharing this vision which we call an **Application Data Platform**.
