...
metaImagePath: "/rust-to-typescript-update-boosting-prisma-orm-performance/imgs/meta.png"
heroImagePath: "/rust-to-typescript-update-boosting-prisma-orm-performance/imgs/hero.svg"
heroImageAlt: "A two-column chart comparing the same findMany benchmark over 25,000 records: 185 ms on the Rust query engine against 55 ms on the Query Compiler, 3.4 times faster."
