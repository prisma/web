...
metaImagePath: "/introducing-graphql-nexus-code-first-graphql-server-development-ll6s1yy5cxl5/imgs/meta.png"
heroImagePath: "/introducing-graphql-nexus-code-first-graphql-server-development-ll6s1yy5cxl5/imgs/hero.svg"
heroImageAlt: "A two-row comparison: SDL-first runs from schema.graphql to resolvers, while the highlighted code-first row runs from makeSchema() to a generated schema.graphql and typings.ts."
