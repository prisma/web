...
metaImagePath: "/tutorial-building-a-realtime-graphql-server-with-subscriptions-2758cfc6d427/imgs/meta.png"
heroImagePath: "/tutorial-building-a-realtime-graphql-server-with-subscriptions-2758cfc6d427/imgs/hero.svg"
heroImageAlt: "Two diagrams on light paper: in the query or mutation lane a client and server exchange a request and a single response; in the subscription lane a dashed long-lived connection stays open while red event markers are pushed back to the client, labelled CREATED, UPDATED, DELETED."
---
