...
metaDescription: "Learn about Apollo Client 2.0, including Apollo Link, local state management, cache updates, and the biggest changes from earlier Apollo Client releases."
metaImagePath: "/all-you-need-to-know-about-apollo-client-2-7e27e36d62fd/imgs/meta.png"
heroImagePath: "/all-you-need-to-know-about-apollo-client-2-7e27e36d62fd/imgs/hero.svg"
heroImageAlt: "A comparison card showing the single react-apollo dependency of Apollo Client 1.x beside the four packages an Apollo Client 2.0 setup imports."
---
