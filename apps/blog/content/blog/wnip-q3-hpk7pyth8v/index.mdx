...
[As previously announced](https://www.prisma.io/blog/prisma-adopts-semver-strictly), Prisma has adopted SemVer strictly and we had our first major release during this quarter (version [`3.0.1`](https://github.com/prisma/orm/releases/tag/3.0.1)), which had some breaking changes.
...
⚠️ **This means you will have to make conscious choices about constraint names when you upgrade.** Please read the [Named Constraints upgrade guide](https://www.prisma.io/docs/guides/upgrade-prisma-orm/v3) for a detailed explanation and steps to follow. ⚠️
