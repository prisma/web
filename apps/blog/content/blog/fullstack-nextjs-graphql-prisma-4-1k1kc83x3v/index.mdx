...
metaImagePath: "/fullstack-nextjs-graphql-prisma-4-1k1kc83x3v/imgs/meta.png"
heroImagePath: "/fullstack-nextjs-graphql-prisma-4-1k1kc83x3v/imgs/hero.svg"
heroImageAlt: "A three-step flow: the admin.tsx upload form posts a file straight to an S3 bucket using a presigned POST from the /api/upload-image route, then the createLink mutation saves the imageUrl in Postgres."
