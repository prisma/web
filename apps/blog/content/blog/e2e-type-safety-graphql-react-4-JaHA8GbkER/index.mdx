...
metaImagePath: "/e2e-type-safety-graphql-react-4-JaHA8GbkER/imgs/meta.png"
heroImagePath: "/e2e-type-safety-graphql-react-4-JaHA8GbkER/imgs/hero.svg"
heroImageAlt: "Flow diagram on light paper: a GraphQL schema URL and a src/**/*.graphql glob merge into graphql-codegen, which outputs a highlighted src/graphql/generated.ts file."
