...
heroImageAlt: "A three-tile flow on paper: several connections from a serverless app converge into a cyan Data Proxy tile labelled connection pooling, which sends one pooled connection on to the database."
tags:
  - "announcement"
  - "platform"
---
