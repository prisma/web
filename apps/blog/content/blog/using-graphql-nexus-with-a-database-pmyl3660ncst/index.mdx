...
heroImageAlt: "A glass prism refracting a single Prisma User model into the GraphQL operations the nexus-prisma plugin generates from it: user, users and createUser."
