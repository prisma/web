...
metaImagePath: "/using-graphql-nexus-with-a-database-pmyl3660ncst/imgs/meta.png"
heroImagePath: "/using-graphql-nexus-with-a-database-pmyl3660ncst/imgs/hero.svg"
heroImageAlt: "An ink code card on paper showing the article's nexus-prisma snippet, with the line 'definition: t => t.prismaFields([*])' picked out by a prism-red highlight row."
