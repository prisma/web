...
metaImagePath: "/accelerate-ipv6-first/imgs/meta.png"
heroImagePath: "/accelerate-ipv6-first/imgs/hero.svg"
heroImageAlt: "The figure $3.60 set in large type above the label: per public IPv4 address, per month, the AWS charge that pushed Prisma Accelerate to an IPv6-first architecture."
tags:
  - "platform"
---
