...
metaImagePath: "/nestjs-prisma-authentication-7D056s1s0k3l/imgs/meta.png"
heroImagePath: "/nestjs-prisma-authentication-7D056s1s0k3l/imgs/hero.svg"
heroImageAlt: "A NestJS controller in a dark code card with the @UseGuards(JwtAuthGuard) line highlighted, an arrow pointing from it to a 401 Unauthorized response card."
