...
> At Prisma, we aim to simplify the process of caching for developers. We understand that setting up a complex infrastructure can be tricky and time-consuming, so [we built Accelerate as a solution](https://www.prisma.io) that makes it easy to cache your database query results in a simple and predictable way. Follow us on [X/Twitter](https://pris.ly/x) or join us on [Discord](https://pris.ly/discord) to learn more about the tools we're building.
