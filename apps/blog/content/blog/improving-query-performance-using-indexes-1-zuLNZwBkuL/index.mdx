...
metaImagePath: "/improving-query-performance-using-indexes-1-zuLNZwBkuL/imgs/meta.png"
heroImagePath: "/improving-query-performance-using-indexes-1-zuLNZwBkuL/imgs/hero.svg"
heroImageAlt: "Two rows of tick marks standing for table rows: the sequential-scan row is entirely grey because every row is read, while the index-scan row is pale with only three ticks lit in yellow."
