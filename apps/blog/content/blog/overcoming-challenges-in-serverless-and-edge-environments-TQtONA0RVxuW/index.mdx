...
> **Note**: Prisma also offers [Accelerate](https://www.prisma.io), a global database cache that could assist in colocating data with your business logic!
...
> **Note**: At Prisma, we're excited about the new paradigms of serverless and edge deployments! To learn what we're building to make it easier for developers to build data-driven applications in these new environments, check out [Accelerate](https://www.prisma.io) and [Prisma Postgres](https://www.prisma.io/postgres) and follow us on [X/Twitter](https://pris.ly/x).
