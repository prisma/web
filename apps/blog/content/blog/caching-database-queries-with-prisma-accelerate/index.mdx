...
metaImagePath: "/caching-database-queries-with-prisma-accelerate/imgs/meta.png"
heroImagePath: "/caching-database-queries-with-prisma-accelerate/imgs/hero.svg"
heroImageAlt: "A freshness timeline for one cached query under the line \"cacheStrategy: { ttl: 300, swr: 120 }\": a solid yellow band labelled \"ttl · 5 min, served from cache as fresh\" followed by a fading band labelled \"swr · 2 min, served stale, revalidating\"."
---
