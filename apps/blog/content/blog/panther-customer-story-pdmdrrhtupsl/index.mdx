...
Panther is keen on ensuring optimal performance of their platform in each layer. For this reason they are excited to use the [Prisma Data Proxy](https://www.prisma.io), which allows you to connect to your database without exhausting database connections in a serverless environment.
