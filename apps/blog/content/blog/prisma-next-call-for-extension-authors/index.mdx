...
The Prisma 8 framework knows about [contracts](https://www.prisma.io/docs/orm/next/contract-authoring/the-data-contract), plans, query lifecycle, and the policies that gate execution. It does _not_ know what Postgres, SQL, Mongo, vectors, or any column type other than `unknown` are.
...
Prisma 8 is in Early Access, and Prisma 7 is the current generally available release, so if you're using it, keep using it.
