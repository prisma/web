...
metaImagePath: "/prisma-migrate-dx-primitives/imgs/meta.png"
heroImagePath: "/prisma-migrate-dx-primitives/imgs/hero.svg"
heroImageAlt: "A white panel headed prisma migrate diff listing the four schema sources it can compare, with the live database schema and migration history rows tinted cyan and tagged from and to."
tags:
  - "announcement"
  - "orm"
---
