...
metaImagePath: "/fullstack-remix-prisma-mongodb-2-ZTmOy58p4re8/imgs/meta.png"
heroImagePath: "/fullstack-remix-prisma-mongodb-2-ZTmOy58p4re8/imgs/hero.svg"
heroImageAlt: "A flow of the article's session-based authentication: sign in, validate, login(), a kudos-session cookie, then the home route, with a dashed error path back to the form."
