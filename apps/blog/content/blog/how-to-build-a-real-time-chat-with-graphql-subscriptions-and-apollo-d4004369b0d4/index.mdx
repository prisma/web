...
metaImagePath: "/how-to-build-a-real-time-chat-with-graphql-subscriptions-and-apollo-d4004369b0d4/imgs/meta.png"
heroImagePath: "/how-to-build-a-real-time-chat-with-graphql-subscriptions-and-apollo-d4004369b0d4/imgs/hero.svg"
heroImageAlt: "A dark code card showing a GraphQL subscription on the Message type, with the mutation field highlighted in cyan beside a comment reading CREATED, UPDATED, DELETED."
---
