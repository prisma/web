...
heroImageAlt: "An AI agent's destructive database command stopped by a Prisma 8 guardrail"
tags:
  - "orm"
  - "ai"
series: prisma-next
...
The first Prisma 8 release candidate comes out in the next week. It's ready for production use, though some features of Prisma 7 aren't present yet.

To get started, run:

```bash
pnpx prisma@8-rc1 init
```
...
[Star and watch the repo](https://github.com/prisma/prisma) to follow progress, and tell us what your agent gets wrong in the [Prisma Discord](https://pris.ly/discord). We're building this in the open, and agent-safety reports are exactly the feedback we're after.
