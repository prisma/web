...
While it was possible to use Prisma ORM in an edge function in earlier versions, this always required usage of [Prisma Accelerate](https://www.prisma.io) as a proxy between the edge function and the database.
