...
metaImagePath: "/convergence/imgs/meta.png"
heroImagePath: "/convergence/imgs/hero.svg"
heroImageAlt: "A comparison card mapping Prisma's relational query options to Drizzle's Relational API v2, joined by cyan equals signs: include = with, select = columns, take = limit."
---
