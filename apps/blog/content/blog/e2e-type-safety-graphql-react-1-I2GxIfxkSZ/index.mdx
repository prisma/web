...
metaImagePath: "/e2e-type-safety-graphql-react-1-I2GxIfxkSZ/imgs/meta.png"
heroImagePath: "/e2e-type-safety-graphql-react-1-I2GxIfxkSZ/imgs/hero.svg"
heroImageAlt: "An ink code card shows the tutorial's src/types.ts file with the Message and User types, the line messages: Message[] highlighted in cyan."
