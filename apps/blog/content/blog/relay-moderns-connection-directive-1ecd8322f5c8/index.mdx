...
metaDescription: "Learn how Relay Modern's @connection directive works and how it helps manage pagination and cache behavior in client apps."
metaImagePath: "/relay-moderns-connection-directive-1ecd8322f5c8/imgs/meta.png"
heroImagePath: "/relay-moderns-connection-directive-1ecd8322f5c8/imgs/hero.svg"
heroImageAlt: "A dark code card showing two lines from Relay Modern's Todo example: the todos field annotated with @connection(key: \"TodoList_todos\") in TodoList.js, and ConnectionHandler.getConnection(userProxy, 'TodoList_todos') in AddTodoMutation.js, with the shared cache key highlighted in both."
---
