...
metaImagePath: "/prisma-data-proxy-xb16ba0p21/imgs/meta.png"
heroImagePath: "/prisma-data-proxy-xb16ba0p21/imgs/hero.svg"
heroImageAlt: "A diagram of five serverless functions converging on one external connection pool that holds the single path to the database."
tags:
  - "announcement"
  - "platform"
---
