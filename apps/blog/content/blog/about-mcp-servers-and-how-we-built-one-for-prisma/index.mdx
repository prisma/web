...
metaImagePath: "/about-mcp-servers-and-how-we-built-one-for-prisma/imgs/meta.png"
heroImagePath: "/about-mcp-servers-and-how-we-built-one-for-prisma/imgs/hero.svg"
heroImageAlt: "A flow diagram in which Cursor, Windsurf and Claude all connect to a single prisma mcp server, which in turn runs Prisma CLI commands."
tags:
  - "education"
  - "orm"
---
