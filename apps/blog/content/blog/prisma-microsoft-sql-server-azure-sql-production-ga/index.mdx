...
metaImagePath: "/prisma-microsoft-sql-server-azure-sql-production-ga/imgs/meta.png"
heroImagePath: "/prisma-microsoft-sql-server-azure-sql-production-ga/imgs/hero.svg"
heroImageAlt: "A soft cyan mesh field on paper with one small white card naming the Prisma datasource provider sqlserver and its status, generally available in 3.0.1."
tags:
  - "announcement"
---
