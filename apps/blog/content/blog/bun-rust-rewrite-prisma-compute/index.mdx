...
If you're evaluating Bun for long-running services, the practical lesson isn't to trust rewrites. It's to test the lifecycle your app will actually live. Start the process and let it idle. Pause and resume it. Cut its sockets. Read some large bodies and watch RSS. Then run the same tests again when the runtime changes. That's how we made this decision, and it's how we'd make the next one.
