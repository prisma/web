...
That idea has been taking shape across Prisma for a while. [Prisma ORM](https://www.prisma.io/orm?utm_source=blog&utm_medium=content&utm_campaign=prisma-rebrand-2026&utm_content=launch-post) simplified working with data. [Prisma Postgres](https://www.prisma.io/postgres?utm_source=blog&utm_medium=content&utm_campaign=prisma-rebrand-2026&utm_content=launch-post) made isolated databases available on demand. [Prisma Compute](https://www.prisma.io/compute?utm_source=blog&utm_medium=content&utm_campaign=prisma-rebrand-2026&utm_content=launch-post) gave applications a place to run.
