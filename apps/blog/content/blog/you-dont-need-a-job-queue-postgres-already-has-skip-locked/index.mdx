...
This is the third post in the [Postgres features series](https://www.prisma.io/blog/series/postgres-features), after [Pub/Sub with `LISTEN` and `NOTIFY`](https://www.prisma.io/blog/you-dont-need-redis-postgres-already-has-pub-sub) and [the bloom index](https://www.prisma.io/blog/postgres-bloom-index-the-overlooked-postgres-feature).
