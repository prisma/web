...
- Building products that solve the new challenges that come with these ecosystems (such as [Accelerate](https://www.prisma.io), a globally distributed database cache)
