...
metaImagePath: "/testing-series-1-8eRB5p0Y8o/imgs/meta.png"
heroImagePath: "/testing-series-1-8eRB5p0Y8o/imgs/hero.svg"
heroImageAlt: "An ink code card showing the manual Prisma Client mock file, with the mockDeep call that returns the deep-mocked client highlighted in cyan."
...
You may want to test a case where a query throws. A good example is Prisma Client's [`findUniqueOrThrow`](https://www.prisma.io/docs/orm/reference/prisma-client-reference#finduniqueorthrow), which throws if no record is found. Because the client is mocked, you trigger the errored state yourself:
