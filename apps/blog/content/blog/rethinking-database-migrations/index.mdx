...
Database migrations are brittle and they break when you're most vulnerable; when you're deploying to production. [Prisma 8 migrations](https://www.prisma.io/docs/orm/next) make them explicit, verifiable and safe to retry. Here's how.
...
In Prisma 8, [a migration](https://www.prisma.io/docs/orm/next/migrations/how-migrations-work) is explicit about what it needs to do and how it does it. Every migration knows:
