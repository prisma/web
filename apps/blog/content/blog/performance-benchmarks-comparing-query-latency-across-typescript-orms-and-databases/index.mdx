...
metaImagePath: "/performance-benchmarks-comparing-query-latency-across-typescript-orms-and-databases/imgs/meta.png"
heroImagePath: "/performance-benchmarks-comparing-query-latency-across-typescript-orms-and-databases/imgs/hero.svg"
heroImageAlt: "A light cover reading 'Which ORM is fastest? It depends' above a table of median findMany latencies for Prisma ORM, Drizzle ORM and TypeORM on Supabase, AWS RDS and Neon."
tags:
  - "orm"
---
