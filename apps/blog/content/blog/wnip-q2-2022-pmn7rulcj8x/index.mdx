...
- [Releases & new features](#releases--new-features)
  ...
  - [General improvements](#general-improvements)
    ...
    - [Explicit unique constraints for 1:1 relations](#explicit-unique-constraints-for-1-relations)
    - [Removed support for usage of `references` on implicit m:n relations](#removed-support-for-usage-of-references-on-implicit-m-relations)
    - [Enforcing uniqueness of referenced fields in the `references` argument in 1:1 and 1:m relations for MySQL](#enforcing-uniqueness-of-referenced-fields-in-the-references-argument-in-1-and-1-relations-for-mysql)
...
[Prisma Day](https://www.prisma.io) was a huge success, and we want to thank everyone who attended and helped make it a great experience! It was a two-day conference with talks and workshops by members of the Prisma community.
...
- [Build A Fullstack App with Remix, Prisma & MongoDB (series)](https://www.prisma.io/blog/series/fullstack-remix-prisma-mongodb)
