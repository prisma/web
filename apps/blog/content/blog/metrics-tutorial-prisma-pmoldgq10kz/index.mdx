...
metaImagePath: "/metrics-tutorial-prisma-pmoldgq10kz/imgs/meta.png"
heroImagePath: "/metrics-tutorial-prisma-pmoldgq10kz/imgs/hero.svg"
heroImageAlt: "A four-stage pipeline on light paper: a highlighted Prisma Client tile calling $metrics.prometheus() feeds a GET /metrics Express endpoint, which Prometheus collects from and Grafana visualizes."
tags:
  - "education"
  - "orm"
---
