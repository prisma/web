...
> **Note**: Metrics is often combined with [tracing](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/opentelemetry-tracing) to get a granular overview of the system. To learn more about tracing, take a look at our [tracing tutorial](https://www.prisma.io/blog/tracing-tutorial-prisma-pmkddgq1lm2).
