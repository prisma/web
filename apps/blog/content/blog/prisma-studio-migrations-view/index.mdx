...
Studio reads that history from the database itself, not from your repo. So it works for any Prisma Next Postgres database you can connect to, including one you have never migrated yourself. The full setup is documented in [Getting Started with Studio](https://www.prisma.io/docs/studio/getting-started).
