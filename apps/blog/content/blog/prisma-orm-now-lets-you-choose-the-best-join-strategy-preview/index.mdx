...
metaImagePath: "/prisma-orm-now-lets-you-choose-the-best-join-strategy-preview/imgs/meta.png"
heroImagePath: "/prisma-orm-now-lets-you-choose-the-best-join-strategy-preview/imgs/hero.svg"
heroImageAlt: "Under the label \"Statements sent for one relation query\", a grey numeral 2 labelled \"query, one query per table\" points by arrow to a large black numeral 1 labelled \"join, one statement, merged in the database\"."
tags:
  - "orm"
  - "education"
---
...
[Support for database-level joins](https://github.com/prisma/prisma/issues/5184) was one of the most requested features in Prisma ORM, and it shipped as the `relationLoadStrategy` option.
...
We'd love for you to try out the `join` relation load strategy. If you don't have a database at hand, `npm create db` gives you a free Prisma Postgres database to experiment with. Let us know what you think and [share your feedback with us](https://github.com/prisma/prisma/discussions/22288)!
