...
- [Releases & new features](#releases--new-features)
  - [Features now in General Availability](#features-now-in-general-availability)
    ...
    - [Index warnings for `relationMode = "prisma"`](#index-warnings-forrelationmode--prisma)
  ...
  - [General improvements](#general-improvements)
    - [Improved serverless experience — smaller engines size](#improved-serverless-experience-with-smaller-engines-size)
    ...
    - [`prisma format` now uses a Wasm module](#prisma-formatnow-uses-a-wasm-module)
    ...
    - [New `P2034` error code for transaction conflicts or deadlocks](#newp2034error-code-for-transaction-conflicts-or-deadlocks)
- [Community](#community)
  - [Meetups](#meetups)
...
Read more about tracing in our [announcement post](https://www.prisma.io/blog/tracing-launch-announcement-pmk4rlpc0ll) and learn more in [our documentation](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/opentelemetry-tracing) on how to start working with tracing.
...
We fixed a bug that prevented the [Prisma Edge Client](https://www.prisma.io/docs/postgres#edge-runtimes) from working with [Cloudflare Module Workers](https://developers.cloudflare.com/workers/learning/migrating-to-module-workers/). We now provide experimental support with a [workaround for environment variables](https://github.com/prisma/orm/issues/13771#issuecomment-1204295665).
...
To make this easier, we're introducing a new [`PrismaClientKnownRequestError`](https://www.prisma.io/docs/orm/reference/error-reference#prismaclientknownrequesterror) with the [error code `P2034`](https://www.prisma.io/docs/orm/reference/error-reference#p2034): "Transaction failed due to a write conflict or a deadlock. Please retry your transaction". You can programmatically catch the error and retry the transaction. Check out the [`4.4.0` release notes](https://github.com/prisma/orm/releases/tag/4.4.0) for further details here and examples.
