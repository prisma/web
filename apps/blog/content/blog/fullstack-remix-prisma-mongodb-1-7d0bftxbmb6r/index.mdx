...
metaImagePath: "/fullstack-remix-prisma-mongodb-1-7d0bftxbmb6r/imgs/meta.png"
heroImagePath: "/fullstack-remix-prisma-mongodb-1-7d0bftxbmb6r/imgs/hero.svg"
heroImageAlt: "Three stacked planes on light paper labelled Remix (React framework), Prisma (object document mapper) highlighted in cyan, and MongoDB (Atlas cluster), beside the headline Building Kudos, step one."
