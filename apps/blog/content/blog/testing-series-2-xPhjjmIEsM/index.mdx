...
metaImagePath: "/testing-series-2-xPhjjmIEsM/imgs/meta.png"
heroImagePath: "/testing-series-2-xPhjjmIEsM/imgs/hero.svg"
heroImageAlt: "Ink code card on light paper: a Vitest unit test where the vi.mock('../lib/prisma') line is highlighted in cyan above a mocked $transaction result and its assertion."
