...
heroImageAlt: "A two-column ledger on light paper: tags.service.ts sits under a cyan-ruled Unit test heading, while quotes.router.ts and quotes.service.ts sit under Skip."
