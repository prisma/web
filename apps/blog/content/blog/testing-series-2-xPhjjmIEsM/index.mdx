...
Looking ahead: Prisma 8 is a TypeScript-native rewrite of Prisma ORM, built for AI coding agents and currently in early access. Until it reaches general availability, Prisma 7 stays the production choice. To try it, run `npm create prisma@next` or read the [early access docs](https://pris.ly/pn-ea).
