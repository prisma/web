...
heroImageAlt: "A four-step flow on a light background — One API call, Prisma Postgres, Vercel deploy, User claims it — with a yellow arrow chain brightening into the final highlighted tile."
---
