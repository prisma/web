...
> **Note:** Tracing is often combined with [metrics](https://www.prisma.io/docs/orm/v7/prisma-client/observability-and-logging/logging) to get better observability of your system. To learn more about metrics, take a look at our [metrics tutorial](https://www.prisma.io/blog/metrics-tutorial-prisma-pmoldgq10kz).
