...
If you want to see how that workflow looks in practice, explore [Prisma ORM](https://www.prisma.io/orm), review how [Prisma Client generation works](https://www.prisma.io/docs/orm/v7/prisma-client/setup-and-configuration/generating-prisma-client), and compare it with [TypedSQL](https://www.prisma.io/typedsql) for the cases where you need lower-level control.
