...
metaImagePath: "/advanced-database-schema-management-with-atlas-and-prisma-orm/imgs/meta.png"
heroImagePath: "/advanced-database-schema-management-with-atlas-and-prisma-orm/imgs/hero.svg"
heroImageAlt: "A diagram where prisma/schema.prisma and published_posts_index.sql both feed an 'atlas migrate diff' composite schema card, which writes to the atlas/migrations directory."
tags:
  - "orm"
  - "education"
---
