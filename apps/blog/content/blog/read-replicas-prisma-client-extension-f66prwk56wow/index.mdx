...
For the example in this article, we'll use [Neon](https://bit.ly/prisma-neon-read-replicas) to create and connect to a read replica. If you already have replicas set up, you can skip to [Connect your read replicas using Prisma Client](#connect-to-your-read-replicas-using-prismaextension-read-replicas).
