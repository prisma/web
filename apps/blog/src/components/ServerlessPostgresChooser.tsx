  ...
  nodes: [
    {
      ...
      options: [
        { label: "A side project or prototype", next: ["free-ppg", "free-neon", "free-supabase"] },
    ...
    },
    {
      ...
      caveat: "The first query after an idle stretch takes a few hundred milliseconds.",
    },
    {
      id: "free-supabase",
      title: "Supabase",
      why: "2 free projects with 500 MB each, plus the bundled backend: auth, storage, and realtime out of the box.",
      caveat: "Free projects pause after a week of inactivity and need a restore.",
    },
    {
      id: "backend",
    ...
    },
    {
      ...
      options: [
        ...
        { label: "More than that", next: ["x-neon", "x-planetscale", "x-supabase", "x-ppg"] },
      ],
    },
    {
      id: "r-ppg",
    ...
    {
      id: "x-neon",
      title: "Neon, auto-suspend disabled",
      why: "About $77/month per always-on CU ($0.106 × 730 hours), with no per-query component at all.",
      caveat: "The worked example in the pricing-models section shows the ~24M crossover against the $49 operations plan.",
    },
    {
      id: "x-planetscale",
      title: "PlanetScale",
      why: "A small always-on instance from $5/month (single node) or $50/month on Metal, prorated to the millisecond.",
      caveat: "No free tier; a quiet month still bills the instance.",
    },
    {
      id: "x-supabase",
      title: "Supabase (paid)",
      why: "$25/month with a Micro instance covered by compute credits; paid projects never pause.",
      caveat: "Instance-shaped: more load means the next instance size, billed hourly.",
    },
    {
      id: "x-ppg",
