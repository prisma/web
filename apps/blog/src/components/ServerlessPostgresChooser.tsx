  ...
  nodes: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: "More than that", next: "r-crossover" },
      ],
    },
    {
      id: "r-ppg",
      ...
      caveat: "Prisma publishes this guide, so hold this recommendation to the same skepticism as the rest. Past roughly 24M queries a month the guide's own worked example shows an always-on Neon compute becomes cheaper; that math is in the pricing-models section above.",
    },
    {
      id: "r-crossover",
      title: "Do the crossover math",
      why: "Above about 10M queries a month the candidates converge and the cheapest depends on your exact numbers: Neon with auto-suspend disabled (about $77/month per always-on CU), a small PlanetScale instance ($5 to $50/month), paid Supabase ($25/month with a Micro covered), or Prisma Postgres on a higher tier ($1 per million operations at the top tier).",
      caveat: "The worked example in the pricing-models section above shows how to run this comparison; at 30M queries a month it lands at about $89 on operations billing versus about $77 on an always-on Neon CU.",
    },
    {
      id: "r-fleet",
