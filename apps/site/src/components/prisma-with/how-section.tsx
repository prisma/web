  ...
  return (
    <div className="my-12">
      <div className="px-4 md:px-8 py-12 flex flex-col gap-12">
        ...
        <div className="max-w-211 mx-auto text-foreground-neutral-weak flex flex-col gap-4 [&>ul]:my-0 [&>ul]:pl-5 [&>ul]:flex [&>ul]:flex-col [&>ul]:gap-2 [&>li]:text-foreground-neutral-weak">
