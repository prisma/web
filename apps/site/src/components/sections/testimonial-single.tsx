      ...
      <div className="mx-auto max-w-site">
        <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
          ...
          <blockquote className="-mt-4 text-xl font-medium leading-relaxed text-foreground sm:text-2xl lg:text-3xl">
            We switched our entire stack over in a weekend. Within a month, our engineering velocity
            doubled and our customers started noticing how much faster we were shipping new
            features.
          </blockquote>
          ...
          <div className="mt-10 flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">VP of Engineering, CloudBase</p>
            </div>
