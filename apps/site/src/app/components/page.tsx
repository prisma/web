    ...
    <div className="space-y-12">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            CSS custom properties defined in globals.css. Change these to rebrand every component at
            once.
          </p>
        </div>
        <div className="grid grid-cols-3 gap-4 sm:grid-cols-4 md:grid-cols-6">
          {colorTokens.map((token) => (
            <div key={token.name} className="space-y-1.5 text-center">
              <div className={`${token.className} h-16 w-full rounded-md border`} />
              <p className="truncate font-mono text-xs text-muted-foreground">{token.name}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4 rounded-lg border p-6">
          ...
          <Separator />
          <div>
            <p className="mb-1 font-mono text-xs text-muted-foreground">small</p>
            <p className="text-sm text-muted-foreground">
              The quick brown fox jumps over the lazy dog. Pack my box with five dozen liquor jugs.
            </p>
          </div>
          <Separator />
          <div>
            <p className="mb-1 font-mono text-xs text-muted-foreground">mono</p>
        ...
        <div className="space-y-2">
          {[1, 2, 3, 4, 6, 8, 10, 12, 16, 20, 24].map((n) => (
            <div key={n} className="flex items-center gap-3">
              ...
              <div className="h-4 rounded bg-primary" style={{ width: `${n * 0.25}rem` }} />
    ...
    <div className="space-y-16">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/button</p>
        </div>
        <div className="space-y-4">
          <div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            @/components/ui/input, textarea, select, checkbox, switch, label, radio-group
          </p>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/card</p>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/badge</p>
        </div>
        <div className="flex flex-wrap gap-3">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/avatar</p>
        </div>
        <div className="space-y-4">
          <div>
            <p className="mb-2 text-sm font-medium">Sizes</p>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/accordion</p>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/tabs</p>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/dialog</p>
        </div>
        <Dialog>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                This is a dialog description. It can contain any content you want to show the user.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <Button variant="outline">Cancel</Button>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/sheet</p>
        </div>
        <Sheet>
          ...
          <SheetContent>
            <SheetHeader>
              ...
              <SheetDescription>
                This is a sheet panel that slides in from the side. Great for forms, navigation, or
                detail views.
              </SheetDescription>
            </SheetHeader>
            <div className="p-4">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/dropdown-menu</p>
        </div>
        <DropdownMenu>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/alert</p>
        </div>
        <div className="max-w-lg space-y-4">
          <Alert>
            ...
            <AlertDescription>
              This is a default alert to inform the user about something important.
            </AlertDescription>
          </Alert>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/table</p>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/progress</p>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/skeleton</p>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/separator</p>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/tooltip</p>
        </div>
        <TooltipProvider>
          <Tooltip>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/toggle</p>
        </div>
        <div className="flex flex-wrap gap-3">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/breadcrumb</p>
        </div>
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/navigation-menu</p>
        </div>
        <NavigationMenu>
          <NavigationMenuList>
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <div className="grid w-[400px] gap-3 p-4">
                  ...
                  <NavigationMenuLink href="#">
                    ...
                    <p className="text-muted-foreground">How to install and set up your project.</p>
                  </NavigationMenuLink>
                </div>
              </NavigationMenuContent>
            </NavigationMenuItem>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/collapsible</p>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/hover-card</p>
        </div>
        <HoverCard>
          ...
          <HoverCardContent className="w-80">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Beautifully designed components built with Radix UI and Tailwind CSS. Open source
                and free to use.
              </p>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/scroll-area</p>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">@/components/ui/toggle-group</p>
        </div>
        <div className="space-y-4">
          <div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="mt-2 text-lg text-muted-foreground">
            Browse design tokens, UI primitives, and page sections. Change CSS variables in
            globals.css to see your brand cascade through every component.
          </p>
        </div>
