...
const what_we_care_about = [
  {
    ...
    imageAlt: "Illustration representing open-source contributions and the Prisma FOSS Fund",
    mobileImageUrl: "/illustrations/about/about_0",
    mobileImageAlt: "Illustration representing open-source contributions and the Prisma FOSS Fund",
    logos: null,
  ...
  },
  {
    ...
    mobileImageAlt: "Illustration representing Prisma's climate change commitments",
    logos: null,
    useDefaultLogos: true,
    alignItems: "items-start" as const,
...
const boxes = [
  ...
  },
  {
    ...
    description: (
      <p className="text-foreground-neutral text-foreground-neutral-weak text-sm font-normal m-0 leading-6">
        We build products that make working with databases easier, turning complex data problems
        into approachable workflows for teams of any size.
      </p>
    ),
  },
];
      ...
      <div className="hero -mt-24 relative flex items-end justify-center px-4 pb-40 pt-30">
        ...
        <div className="content relative z-2 my-12 flex flex-col gap-8 mt-30 py-12">
          ...
          <p className="text-center text-foreground-neutral max-w-2xl mx-auto mb-12">
            Our mission is to make working with databases easy, with a great developer experience at
            the core of every product we build.
          </p>
