...
function PrismaOGImage({ badge, title, description, footer }: OGImageContent) {
  return (
    <div
      style={{
        height: "100%",
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        <h1
          style={{
            fontSize:
              title.length > LONG_TITLE_THRESHOLD ? LONG_TITLE_FONT_SIZE : DEFAULT_TITLE_FONT_SIZE,
            fontWeight: 700,
            fontFamily: "Barlow, sans-serif",
            color: "#f7fafc",
            lineHeight: 1.2,
...
export async function createOGImageResponse(content: OGImageContent) {
  ...
  return new ImageResponse(<PrismaOGImage {...content} />, {
    width: 1200,
    height: 630,
    fonts,
  });
