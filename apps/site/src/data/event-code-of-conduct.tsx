    ...
    content: (
      <>
        <p>
          ...
          We do not tolerate harassment of event participants in any form. Sexual language and
          imagery are not appropriate for any event venue, including talks, workshops, parties,
          Twitter, Slack, and other online media.
        </p>
        <p>
    ...
    content: (
      <>
        <p>
          ...
          ethnicity, religion, technology choices, deliberate intimidation, stalking, following,
        ...
        <p>
          ...
          identified by their badges or clothing.
        </p>
        <p>
