...
- [Search encrypted data with Prisma 8 and CipherStash](https://www.prisma.io/blog/search-encrypted-data-with-prisma-8-and-cipherstash): query encrypted columns through expression indexes with CipherStash's Prisma support.
