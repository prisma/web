...
---
Prisma 8 now runs a stock Supabase project end to end through `@prisma-next/extension-supabase`, and adds Row-Level Security policy authoring in the schema and in TypeScript, plus managed native PostgreSQL enum migrations.
