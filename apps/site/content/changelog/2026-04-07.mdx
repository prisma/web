...
Prisma ORM v7.7.0 introduces a new `prisma bootstrap` command that sequences the full [Prisma Postgres](https://www.prisma.io/postgres) setup into a single interactive flow.
