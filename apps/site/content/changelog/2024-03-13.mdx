...
---
We're thrilled to announce that [Pulse](https://www.prisma.io/postgres) has reached General Availability! This marks a significant milestone in our journey to redefine how developers interact with database-event driven compute.
...
We’re excited to launch the [**Prisma Partner Network**](https://www.prisma.io/programs/partners) with tailored opportunities for affiliates, tech partners, and resellers.

**👉 [prisma.io/partners](https://www.prisma.io/programs/partners)**
