...
const PAIRS = [
  ...
  {
    before: "Context-switching between a database dashboard, ORM CLI, hosting console, and data browser",
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative mt-12 overflow-hidden rounded-[1.5rem] border border-black/[0.06] bg-white">
          ...
          <div className="relative grid lg:grid-cols-2">
            <p className="px-8 pt-8 text-sm text-muted-foreground max-lg:hidden">
              Before
            </p>
            <p className="px-8 pt-8 text-sm font-semibold text-foreground max-lg:hidden">
              After
            </p>
            {PAIRS.map(({ before, after, tone }) => (
              <Fragment key={after}>
                <BeforeCell className="max-lg:bg-muted/60 lg:pr-16">
                  {before}
                </BeforeCell>
    ...
    <section className="bg-white px-4 py-20 sm:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative mt-12 overflow-hidden rounded-[1.5rem] border border-black/[0.06]">
          ...
          <div aria-hidden className="absolute inset-y-0 left-1/2 hidden w-40 -translate-x-1/2 lg:block">
            <div
    ...
    <section className="bg-white px-4 py-20 sm:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative mt-12 overflow-hidden rounded-[1.5rem] border border-black/[0.06]">
          <div
            aria-hidden
            className="absolute inset-y-0 left-0 w-1/2 bg-muted/60 max-lg:hidden"
          />
          <div
            aria-hidden
            className="absolute inset-y-0 left-1/2 hidden w-[3px] -translate-x-1/2 lg:block"
    ...
    <div className="bg-white pb-32 pt-36">
      <div className="container mx-auto max-w-[96rem] px-4">
        ...
        <p className="mt-3 max-w-[62ch] text-sm leading-relaxed text-muted-foreground">
          Six takes on the divide: one wrapped panel, two surfaces, the triple
          band on the seam. 01 is the baseline; 02 to 06 each change one thing.
        </p>
