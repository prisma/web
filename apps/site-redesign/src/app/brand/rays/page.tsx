    ...
    <div className="bg-white pb-32 pt-36">
      ...
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <p className="mt-3 max-w-[62ch] text-muted-foreground">
          Round three. The pattern in everything approved so far: the ray is a
          state, not a decoration — it scans, loads, activates, progresses. These
          options push further into that territory.
        </p>
        ...
        >
          <div className="flex flex-wrap items-center gap-10 rounded-xl border border-border/70 bg-card p-8">
            ...
            <div className="flex items-center gap-3">
              <span className="relative inline-flex rounded-full p-[2.5px]" style={{ background: PRISM_CONIC }}>
            ...
            <span className="flex items-center gap-2 rounded-full border border-border/70 px-3 py-1.5 text-xs font-semibold">
              <span className="relative flex size-2">
                ...
                />
                <span className="relative inline-flex size-2 rounded-full" style={{ background: PRISM_CONIC }} />
              </span>
              Live
            </span>
          </div>
        ...
        >
          <div className="max-w-sm overflow-hidden rounded-xl border border-border/70 bg-card shadow-[0_12px_32px_-12px_rgba(21,21,21,0.16)]">
            <div className="flex items-center gap-2 border-b border-border/70 px-4 py-3 text-sm text-muted-foreground">
              ...
              Search…
              <span className="ml-auto rounded border border-border/70 px-1.5 py-0.5 text-[0.625rem]">⌘K</span>
            </div>
        ...
        >
          <div className="max-w-sm overflow-hidden rounded-xl border border-border/70 bg-card shadow-[0_12px_32px_-12px_rgba(21,21,21,0.16)]">
            ...
            <span aria-hidden className="ray-countdown block h-[3px]" style={{ background: prismBands() }} />
          </div>
        </Demo>
            ...
            <div className="w-64 rounded-xl border border-border/70 bg-card p-5">
              ...
              <div className="mt-3 flex h-12 items-end gap-1.5">
                {[35, 55, 40, 70, 50, 80].map((h, i) => (
                  <span key={i} className="flex-1 rounded-t bg-foreground/10" style={{ height: `${h}%` }} />
                ))}
                <span
