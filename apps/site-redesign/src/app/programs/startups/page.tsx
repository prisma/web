            ...
            <ul className="mt-5 flex flex-col gap-2.5">
              {ELIGIBILITY.map((item) => (
                <li key={item} className="flex items-start gap-3 text-[0.9375rem] font-medium">
                  <span aria-hidden className="mt-2 size-2 shrink-0 rounded-full bg-prism-cyan-400" />
                  {item}
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul className="mt-5 flex flex-col gap-2.5">
              {BOOTSTRAPPED.map((item) => (
                <li key={item} className="flex items-start gap-3 text-[0.9375rem] font-medium">
                  <span aria-hidden className="mt-2 size-2 shrink-0 rounded-full bg-prism-yellow-300" />
                  {item}
                </li>
              ))}
            </ul>
