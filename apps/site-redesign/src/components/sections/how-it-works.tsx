...
const STEPS = [
  {
    ...
    body: (
      <>
        ...
        , or have your agent write it for you. It&apos;s the shared contract your ORM,
        migrations, and data layer are all built around.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        Add Prisma Postgres and Compute when you&apos;re ready to ship. Your app and
        database deploy together on the same host, co-located by default.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        Your agent reads logs, fixes what broke, and redeploys through one CLI and
        Management API. The loop runs for as long as you need it to.
      </>
    ),
  },
]
