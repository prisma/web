        ...
        <form onSubmit={handleSubmit} className="mt-7 flex flex-col gap-5">
          <div className="grid gap-5 sm:grid-cols-2">
            <div className="flex flex-col gap-2">
              ...
              <Input id="contact-name" name="name" autoComplete="name" required className={`h-11 ${FIELD}`} />
            </div>
            <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Textarea id="contact-message" name="message" required className={`min-h-32 ${FIELD}`} />
          </div>
