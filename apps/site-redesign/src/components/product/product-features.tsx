...
// content, the feature's abstraction filling the block. Two rows of two,
// inside the homepage stack's wrapped panel.
      ...
      <div className="relative mx-auto max-w-[96rem] overflow-hidden rounded-[1.5rem] border border-black/[0.06] bg-white">
        ...
        <div className="relative mx-auto max-w-site px-4 py-20 sm:px-8 sm:py-24">
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-2">
            {features.items.map(({ name, description, href }, i) => (
              <Reveal key={i} delay={(i % 2) * 0.1} className="h-full">
                <div className="flex h-full flex-col overflow-hidden rounded-2xl border border-black/[0.06] bg-card">
                  ...
                  <div
                    aria-hidden
                    className="relative flex h-80 select-none items-center justify-center overflow-hidden p-6"
                  >
                    <div
                      className={cn(
                    ...
                    />
                    <div className="relative flex h-full w-full items-center justify-center rounded-xl border border-dashed border-black/20 bg-white/70 backdrop-blur-sm">
                  ...
                  <div className="flex grow flex-col p-6">
                    ...
                    <p className="mt-3 grow text-pretty text-[0.9375rem] leading-relaxed text-muted-foreground">
                      {description}
                    </p>
