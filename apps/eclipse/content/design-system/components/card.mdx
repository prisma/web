...
export function CardWithDescription() {
  return (
    <Card>
      ...
      <CardContent>
        Prisma unlocks a new level of developer experience when working with databases thanks to its
...
<Card>
  ...
  <CardContent>
    Learn how to set up Prisma ORM in your Next.js application and start building type-safe database
    queries.
  </CardContent>
  <CardFooter>
