...
<div className="space-y-4 my-4">
  <div className="flex items-center gap-2">
    <Switch id="controlled-example" />
    <label htmlFor="controlled-example" className="text-sm font-medium cursor-pointer">
      Feature enabled
    </label>
  </div>
</div>
...
The Switch component supports two sizes: `sm` (small) and `default`:
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <label htmlFor="small" className="text-sm font-medium">Small switch</label>
      </div>
      <div className="flex items-center gap-2">
        <Switch id="default" size="default" />
        <label htmlFor="default" className="text-sm font-medium">Default switch</label>
      </div>
    </div>
  );
}
...
<div className="space-y-4 my-4">
  <div className="flex items-center gap-2">
    <Switch id="small-example" size="sm" />
    <label htmlFor="small-example" className="text-sm font-medium cursor-pointer">Small switch</label>
  </div>
  <div className="flex items-center gap-2">
    <Switch id="default-example" size="default" />
    <label htmlFor="default-example" className="text-sm font-medium cursor-pointer">Default switch</label>
  </div>
</div>
...
- `size` - Size variant: `"sm"` or `"default"` (default: "default")
...
- Use the small size (`sm`) for compact UIs or inline controls
