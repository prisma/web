// Generates content/docs/orm/reference/error-reference.mdx from the
...
// https://docs.prisma.io/docs/orm/reference/error-reference#<CODE>
// (builds that predate the Prisma 8 promotion emit /orm/next/... or
// /orm/v8/..., which 308-redirect here with the fragment preserved), so each `### NAMESPACE.SUBCODE` heading
...
const OUTPUT = join(
  ...
  "../content/docs/orm/reference/error-reference.mdx",
);
