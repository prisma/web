...
Standalone Prisma Accelerate will be retired on December 1, 2026. You can [migrate a PostgreSQL database to Prisma Postgres](/prisma-postgres/import-from-existing-database-postgresql) or [keep your existing database and remove Accelerate](/accelerate/keep-your-database).
