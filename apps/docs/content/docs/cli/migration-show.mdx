...
description: Inspect a Prisma ORM migration package.
url: /cli/migration-show
metaTitle: migration show | Prisma ORM CLI
metaDescription: 'Learn how to inspect Prisma ORM migration operations, statements, and metadata.'
---
...
```npm
npx prisma migration show <target>
```
...
```npm
npx prisma migration show 20260101_100000_add_user
npx prisma migration show a1b2c3
npx prisma migration show migrations/app/20260101_100000_add_user
npx prisma migration show 20260101_100000_add_user --json
```
