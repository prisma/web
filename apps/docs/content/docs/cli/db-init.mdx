---
title: db init
description: Initialize a database from the current Prisma ORM contract.
url: /cli/db-init
metaTitle: db init | Prisma ORM CLI
metaDescription: Learn how to create missing database structures from a Prisma ORM contract and sign the database.
---
...
Use [`db update`](/cli/db-update) when the database already exists and you want Prisma ORM to reconcile it with a changed contract. Use [`migration plan`](/cli/migration-plan) when you want a reviewable migration package in version control.
