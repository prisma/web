...
Use [`prisma-next db update`](/cli/v8/db-update) when the database already exists and you want Prisma 8 to reconcile it with a changed contract. Use [`prisma-next migration plan`](/cli/v8/migration-plan) when you want a reviewable migration package in version control.
