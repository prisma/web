...
For reviewable database changes in version control, use [`prisma-next migration plan`](/cli/v8/migration-plan) and [`prisma-next migration apply`](/cli/v8/migration-apply).
