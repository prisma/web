...
description: Manage named Prisma 8 migration refs.
url: /cli/v8/migration-ref
metaTitle: prisma-next migration ref
metaDescription: Learn how to set, get, list, and delete Prisma 8 migration refs.
---

`prisma-next migration ref` manages named refs stored with your migration history.

Refs let you name a migration hash and use that name in commands such as [`prisma-next migration apply --ref <name>`](/cli/v8/migration-apply).
