...
Use a [Prisma 8 quickstart](/v8/quickstart/postgresql) when you want a complete new application template. Use `prisma-next init` when you already have a project and want to add the lower-level Prisma 8 files.
