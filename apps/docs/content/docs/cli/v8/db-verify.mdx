...
```npm
npx @prisma/cli@next db verify --db "$DATABASE_URL"
npx @prisma/cli@next db verify --db "$DATABASE_URL" --strict
npx @prisma/cli@next db verify --db "$DATABASE_URL" --schema-only
npx @prisma/cli@next db verify --db "$DATABASE_URL" --marker-only
```
