...
```npm
npx prisma@next migration show <target>
```
...
```npm
npx prisma@next migration show 20260101_100000_add_user
npx prisma@next migration show a1b2c3
npx prisma@next migration show migrations/app/20260101_100000_add_user
npx prisma@next migration show 20260101_100000_add_user --json
```
