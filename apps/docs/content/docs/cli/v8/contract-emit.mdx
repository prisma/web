...
- use [`prisma-next db init`](/cli/v8/db-init) for first-time bootstrap
- use [`prisma-next db update`](/cli/v8/db-update) for direct reconciliation
- use [`prisma-next migration plan`](/cli/v8/migration-plan) for checked-in migrations
- use [`prisma-next db verify`](/cli/v8/db-verify) to check drift
