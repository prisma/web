...
First, you need to create a service token to be able to access the REST API:
...
You're going to use [`axios`](https://github.com/axios/axios/tree/main) as your HTTP client to interact with the REST API. Install it as follows:
