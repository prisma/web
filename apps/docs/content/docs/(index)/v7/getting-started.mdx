...
Starting a new project? [Prisma 8](/prisma-orm) is the recommended path for new apps. It is the current major version of Prisma ORM. To start with Prisma 8, see the [getting started page](/).
