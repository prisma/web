...
The route handler in `src/index.ts` is ordinary Hono code calling an ordinary Prisma 8 query. Change the starter contract in `src/prisma/` when you are ready to model your own data; the [fundamentals](/orm/fundamentals/reading-data) cover the query patterns.
