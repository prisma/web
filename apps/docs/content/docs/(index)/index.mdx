...
Prisma is a complete TypeScript stack with one workflow: **build** your app and run all of it on your machine, then **deploy** it to the Prisma platform with one command. Jump straight to the [full-stack tutorial](/v8/full-stack-tutorial), [Prisma 8](/v8) or [Prisma 7](/getting-started) docs.

<WorkflowGrid>
  <WorkflowStage title="Build" description="Define the app in TypeScript and run everything locally before you ship.">
    <WorkflowLink href="/composer/local-development" title="Local development" icon={<Laptop />}>
  ...
  <WorkflowStage title="Deploy" description="One deploy provisions everything on the Prisma platform and connects it.">
    ...
    <WorkflowLink href="/compute/deployments" title="Deploy" icon={<Rocket />}>
