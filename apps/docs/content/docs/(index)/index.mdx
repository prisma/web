...
<HeroGrid>
  <HeroPitch
    ...
    primaryHref="/v8/full-stack-tutorial"
    primaryLabel="Start the full-stack tutorial"
    secondaryHref="/getting-started"
    secondaryLabel="Prisma 7 docs"
  >
    Prisma is a complete TypeScript stack for building with data: [Prisma ORM](/orm) to model and query it, [Prisma Postgres](/postgres) to store it, and [Prisma Compute](/compute) to run your app next to it. Start new projects with [Prisma 8](/v8), the next major version of the ORM: one scaffold command wires up all three, for you or your coding agent.
  </HeroPitch>
...
npm run db:init
npm run db:seed
# db:seed failing? See the one-line fix: prisma.io/docs/v8/full-stack-tutorial
npm run dev
