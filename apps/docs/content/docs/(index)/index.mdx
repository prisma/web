...
<HeroGrid>
  ...
  <StackDiagram caption="One project. Type-safe, end to end.">
    ...
    <StackLayer title="Prisma Next" icon={<Sparkles />}>
...
<AgentPrompt title="Prisma Next with your own PostgreSQL database" guideHref="/next/quickstart/postgresql" guideTitle="Quickstart" icon={<Plug />}>
