...
url: /v8/add-to-existing-project/mongodb
...
Use this path when you already have an application and database. Make sure the app can already reach its MongoDB deployment and runs on Node.js 24 or newer. If you want Prisma 8 to create a new app for you, use the [MongoDB quickstart](/v8/quickstart/mongodb).
...
You do not need a migration just to read collections that already exist. Use [migration plan](/cli/v8/migration-plan) when you want Prisma 8 to own a schema change.
