...
url: /next/contract-authoring/capabilities
...
- See where the `capabilities` block sits in [the contract artifact](/next/contract-authoring/the-contract-artifact).
