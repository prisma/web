...
description: Prisma 8 is the next major version of Prisma ORM, available in Early Access.
url: /next
metaTitle: Introduction to Prisma 8
metaDescription: Start here for Prisma 8, the Early Access rebuild of Prisma ORM. Quickstarts, framework guides, and agent prompts.
badge: early-access
hideSidebar: true
---
...
<Cards>
  <Card href="/orm/next" title="Prisma 8 overview" icon={<BookOpen className="text-primary" />}>
