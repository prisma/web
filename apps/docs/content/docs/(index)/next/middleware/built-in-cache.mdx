...
url: /next/middleware/built-in-cache
...
- [Authoring custom middleware](/next/middleware/authoring-custom-middleware), including how `intercept` short-circuiting works
