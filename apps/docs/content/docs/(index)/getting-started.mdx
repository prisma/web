...
Starting a new project? [Prisma 8](/next) is the recommended path for new apps. It is the next major version of Prisma ORM, available now in Early Access. The [getting started page](/) covers it.
