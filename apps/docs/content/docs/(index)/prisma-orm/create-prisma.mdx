...
| `--skills <agents>\|none` | Which coding agents get skill files, or `none` to opt out. Same values and effect as [`prisma init --skills`](/cli/init); the choice is recorded in the [`skills` config section](/cli/configuration#agent-skills). |
