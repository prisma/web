...
`create-prisma@latest` scaffolds Prisma ORM 8. To scaffold a Prisma ORM 7 app, run `npm create prisma@stable` and follow the [Prisma 7 setup paths](/v7/getting-started).
