---
title: PostgreSQL
description: Create a new Prisma ORM project with PostgreSQL using create-prisma@latest.
url: /prisma-orm/quickstart/postgresql
metaTitle: 'Quickstart: Prisma ORM with PostgreSQL'
metaDescription: 'Scaffold a Prisma ORM project with PostgreSQL, initialize the database, and run your first query.'
---
