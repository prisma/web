...
Use this path when you already have an application and database. Make sure the app can already reach its PostgreSQL database and runs on Node.js 22.18 or newer, or 24.11 or newer (Node.js 24 is recommended). If you want Prisma 8 to create a new app for you, use the [PostgreSQL quickstart](/prisma-orm/quickstart/postgresql).
