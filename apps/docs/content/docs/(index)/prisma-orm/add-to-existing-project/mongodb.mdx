...
Use this path when you already have an application and database. Make sure the app can already reach its MongoDB deployment and runs on Node.js 22.18 or newer (on the 24 line, 24.11 or newer) (Node.js 24 is recommended). If you want Prisma 8 to create a new app for you, use the [MongoDB quickstart](/prisma-orm/quickstart/mongodb).
