---
title: From the CLI
description: Start a Prisma ORM app with Prisma Postgres from the command line.
url: /prisma-postgres/from-the-cli
metaTitle: Prisma ORM with Prisma Postgres from the CLI
metaDescription: Start a Prisma ORM app with Prisma Postgres from the command line.
---
...
Choose PostgreSQL and set `DATABASE_URL` to your Prisma Postgres connection string. Init adds `prisma-next.md`, package scripts, and the Prisma ORM skills for your coding agent. Then follow the [PostgreSQL existing-project guide](/prisma-orm/add-to-existing-project/postgresql).
