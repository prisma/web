...
Alchemy provisions the database but does not infer or run production schema migrations. Run migrations separately or model them as a dependency before Compute, as shown in the linked TanStack Start example.
