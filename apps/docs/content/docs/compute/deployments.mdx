...
npx prisma service open web
npx prisma service version list web
npx prisma service version show ver_123
```
...
```npm
npx prisma service version promote ver_123
```
...
```npm
npx prisma service version stop ver_123
npx prisma service version start ver_123
npx prisma service version delete ver_123
```
