...
A branch is an isolated environment for one line of work. Every branch in a project gets its own services, databases, and deployments, so work on a preview never touches production.
