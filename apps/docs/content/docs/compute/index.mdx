...
Prisma Compute is TypeScript app hosting built to run alongside [Prisma Postgres](/postgres). It is the last step of the [recommended Prisma stack](/): you model your data with [Prisma 8](/next) or [Prisma ORM](/orm), store it in Prisma Postgres, and deploy your app with Prisma Compute, so your schema, database, hosting, and branch previews work together in one Prisma project.
