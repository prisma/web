...
<Cards>
  <Card href="/prisma-postgres/quickstart/prisma-orm" title="Prisma ORM quickstart" icon={<Rocket className="text-primary" />}>
    Define a data contract and query with Prisma ORM.
  </Card>
...
- If you use [Prisma ORM](/prisma-orm), the quickstart provisions a database and connects it to your data contract.
