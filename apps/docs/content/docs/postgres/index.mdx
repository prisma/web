...
New to Prisma Postgres? Start here. In the [recommended stack](/), Prisma Postgres is the database behind a [Prisma 8](/next) app, and [Prisma Compute](/compute) later runs that app next to it.
