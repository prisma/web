...
- **Connection pooling**: a dedicated PgBouncer instance runs alongside your database, with nothing to set up or manage. It also covers serverless and edge deployments. See [Connection pooling](/postgres/database/connection-pooling).
