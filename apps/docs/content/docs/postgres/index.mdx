...
New to Prisma Postgres? Start here. In the [recommended stack](/), Prisma Postgres is the database behind a [Prisma Next](/next) app, and [Prisma Compute](/compute) later runs that app next to it.

<Cards>
  <Card href="/prisma-postgres/quickstart/prisma-next" title="Quickstart with Prisma Next" icon={<Rocket className="text-primary" />}>
    Scaffold a Prisma Next app and let setup provision Prisma Postgres.
  </Card>
