...
Query Insights is built into Prisma Postgres and helps you understand which queries are slow, why they are expensive, and what to change next. It is currently in Early Access and available to try in the [Prisma Console](https://console.prisma.io).
...
:::info
Query Insights has its own dedicated section with full documentation, examples, and setup instructions. See [Query Insights](/docs/query-insights).
:::