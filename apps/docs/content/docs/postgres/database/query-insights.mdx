...
metaTitle: Query Insights for a Prisma Postgres database
metaDescription: 'How Query Insights surfaces slow queries for a Prisma Postgres database in the Prisma Console, and where the full documentation lives.'
---
