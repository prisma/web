...
| --- | --- | --- |
| Conventional Node.js or Bun runtime with PostgreSQL TCP support | [Pooled TCP](/postgres/database/connection-pooling) | `@prisma/adapter-pg` for Prisma ORM 7 |
...
```npm title="Terminal" tab="Prisma ORM 7"
npm uninstall @prisma/extension-accelerate
npm install @prisma/adapter-pg pg
```

```npm title="Terminal" tab="Prisma ORM 6.19"
npm uninstall @prisma/extension-accelerate
...
```ts title="prisma.config.ts" tab="Prisma ORM 7"
...
```ts title="src/lib/prisma.ts" tab="Prisma ORM 7"
...
```prisma title="prisma/schema.prisma" tab="Prisma ORM 6.19"
generator client {
...
```ts title="src/lib/prisma.ts" tab="Prisma ORM 6.19"
