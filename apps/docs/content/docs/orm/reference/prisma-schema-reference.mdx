...
- [Prisma schema overview](/orm/prisma-schema/overview) if you want a guided explanation of how schema pieces fit together
- [Data model / models](/orm/prisma-schema/data-model/models) for practical modeling patterns beyond the raw reference
- [Prisma Migrate getting started](/orm/prisma-migrate/getting-started) if you are ready to apply schema changes to a real database
- [Add Prisma ORM to an existing PostgreSQL project](/prisma-orm/add-to-existing-project/postgresql) if you want to connect this schema workflow to a live application
