...
- Since `8.0.0-rc.10` it also works on ORM queries: `ResultType<typeof db.orm.public.User.include('posts')>`. See [Named model types](/orm/reference/orm-client#named-model-types).
