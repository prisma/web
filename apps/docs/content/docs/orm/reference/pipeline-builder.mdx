...
description: 'Reference for the Prisma ORM MongoDB pipeline builder''s stages, accumulators, expression helpers, and write terminals.'
url: /orm/reference/pipeline-builder
metaTitle: Prisma ORM MongoDB pipeline builder reference
metaDescription: 'Reference for the Prisma ORM MongoDB pipeline builder''s stages, accumulators, expression helpers, and write terminals.'
---
