...
- use the `@prisma/adapter-pg` database adapter (learn more in [Using driver adapters](/orm/v7/core-concepts/supported-databases/postgresql#using-driver-adapters))
...
- use the `@prisma/adapter-planetscale` database adapter (learn more in [PlanetScale](/orm/v7/core-concepts/supported-databases/mysql#planetscale))
...
- use the `@prisma/adapter-neon` database adapter (learn more in [Using driver adapters](/orm/v7/core-concepts/supported-databases/postgresql#using-driver-adapters))
