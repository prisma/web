...
If you want to deploy an app using Turso, you can follow the instructions in [Using driver adapters](/orm/v7/core-concepts/supported-databases/sqlite#using-driver-adapters).
