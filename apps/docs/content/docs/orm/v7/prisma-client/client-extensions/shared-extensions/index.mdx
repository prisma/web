...
To explore examples of Prisma's official Client extensions and those made by the community, visit the [Shared packages & examples](/orm/v7/prisma-client/client-extensions/extension-examples).
