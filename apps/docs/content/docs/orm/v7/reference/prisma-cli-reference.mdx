...
| Argument              | Required | Description                                                                                                                                                 | Default   |
| --------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| `--name` (or `-n`)    | No       | Enables targeting a specific database instance. Learn more about [using different local Prisma Postgres instances](/local-development/postgres#using-different-local-prisma-postgres-instances). | `default` |
...
You can find the complete list of available commands with the arguments in the [`prisma platform` command reference](/cli/v7/console).
...
For full usage details, options (such as `--region` and `--interactive`), and examples, see the [`npx create-db` reference](/postgres/npx-create-db).
