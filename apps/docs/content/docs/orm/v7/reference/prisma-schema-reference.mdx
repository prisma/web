...
Learn more about PostgreSQL connection strings in the [PostgreSQL](/orm/v7/core-concepts/supported-databases/postgresql) documentation.
...
| `output`          | No       | String (file path)           | Determines the location for the generated client, learn more about [fields for `prisma-client` provider](/orm/v7/reference/prisma-schema-reference#fields-for-prisma-client-provider). **Default**: `node_modules/.prisma/client` |
...
| `output`                 | **Yes**  | String (file path)                                                                                                 | Determines the location for the generated client, learn more about [fields for `prisma-client` provider](/orm/v7/reference/prisma-schema-reference#fields-for-prisma-client-provider).                                                                           |
| `previewFeatures`        | No       | List of Enums                                                                                                      | Use intellisense to see list of currently available Preview features (`Ctrl+Space` in Visual Studio Code) **Default**: none                                                                                                               |
...
Defines meta information about the relation. Learn more about [the `@relation` attribute](/orm/v7/prisma-schema/data-model/relations#the-relation-attribute).
...
For more information about using the `multiSchema` feature, refer to [Multi-schema](/orm/v7/prisma-schema/data-model/multi-schema).
