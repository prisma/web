...
- easy and type-safe querying of nested data without worrying about underlying SQL ([docs](/orm/v7/prisma-client/queries/relation-queries#nested-reads))
