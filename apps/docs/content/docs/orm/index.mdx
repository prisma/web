...
Prisma 8 is the next major version of Prisma ORM, now available as a Release Candidate. Start with the [Prisma 8 getting started guide](/v8) and share feedback in [Discord](https://pris.ly/discord?utm_source=docs&utm_medium=inline_text). This section documents Prisma 7, the current generally available release.
...
<Cards>
  ...
  <Card href="/orm/v8" title="Prisma 8 docs" icon={<Sparkles className="text-primary" />}>
