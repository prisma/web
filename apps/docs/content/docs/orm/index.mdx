...
Prisma 8 is the next major version of Prisma ORM, now available as a Release Candidate. Start with the [Prisma 8 getting started guide](/next) and share feedback in [Discord](https://pris.ly/discord?utm_source=docs&utm_medium=inline_text). This section documents Prisma 7, the current generally available release.
...
<Cards>
  ...
  <Card href="/orm/next" title="Prisma 8 docs" icon={<Sparkles className="text-primary" />}>
    The Release Candidate docs for the next major version.
  </Card>
</Cards>
