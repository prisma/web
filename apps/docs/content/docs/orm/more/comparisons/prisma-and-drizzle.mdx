...
Prisma ORM has begun adding support for [third-party database drivers](/blog/serverless-database-drivers-kml1ehxorxzv). Prisma also defaults connections to TLS, which improves security.
