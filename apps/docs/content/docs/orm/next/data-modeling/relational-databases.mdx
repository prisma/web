...
metaDescription: How to model one-to-one, one-to-many, many-to-many, and polymorphic relations in Prisma Next for PostgreSQL, including which side owns the foreign key.
badge: early-access
---
