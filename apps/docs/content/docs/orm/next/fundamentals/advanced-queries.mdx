...
```js no-copy
[
  { authorId: 'zmlhqodhz2tj5pztggwa50nm', posts: '2' },
  { authorId: 'yvp1col4louhkzxyycg4tnur', posts: '1' }
]
```
...
```js no-copy
[
  { _id: new ObjectId('6a4b70352eabdda01b0e6af5'), postCount: 3 },
  { _id: new ObjectId('6a4b70352eabdda01b0e6af4'), postCount: 2 }
]
```
