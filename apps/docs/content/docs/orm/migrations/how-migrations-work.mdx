...
These commands live under the [Prisma ORM CLI](/cli). Run them with `npx prisma@latest <command>`. The planning and inspection commands work offline. They read files, not your database:
