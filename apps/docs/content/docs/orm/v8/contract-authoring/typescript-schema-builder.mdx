...
If neither applies, write PSL: it is more compact, and it is what `create-prisma` scaffolds and [`prisma-next contract infer`](/cli/v8/contract-infer) writes.
