...
url: /orm/v8/middleware/built-in-cache
...
- [Authoring custom middleware](/orm/v8/middleware/authoring-custom-middleware), including how `intercept` short-circuiting works
- [Built-in: budgets](/orm/v8/middleware/built-in-budgets)
