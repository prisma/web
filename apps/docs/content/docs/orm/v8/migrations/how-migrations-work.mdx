...
These commands live under the [Prisma 8 CLI](/cli/v8). Run them with `npx prisma@next <command>`. The planning and inspection commands work offline. They read files, not your database:
