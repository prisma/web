...
Everything lives under the [Prisma 8 CLI](/cli/v8); run them with `npx prisma@next <command>`. Planning and inspection are offline; they read files, not your database:
