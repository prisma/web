...
Prisma 8 rewrites Prisma ORM in TypeScript. It keeps the schema-first workflow and model-first queries from earlier versions, and introduces a new query API, an extension system, and a revised migration workflow. This page gives you the mental model; the [quickstart](/v8/quickstart/postgresql) gets you to a running query.
