...
- From v2.23.0, but before v4.0.0: advanced `Json` filtering is a [preview feature](/orm/v6/reference/preview-features/client-preview-features). Add `previewFeatures = ["filterJson"]` to your schema. Learn more about [enabling a Prisma Client Preview feature](/orm/v6/reference/preview-features/client-preview-features#enabling-a-prisma-client-preview-feature).
