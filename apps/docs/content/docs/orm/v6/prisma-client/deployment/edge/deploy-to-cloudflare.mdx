...
npm install prisma@6.19.3 --save-dev && npm install @prisma/client@6.19.3
...
```npm
npm install @prisma/adapter-pg@6.19.3
```
...
```npm
npm install @prisma/adapter-planetscale@6.19.3
```
...
```npm
npm install @prisma/adapter-neon@6.19.3
```
