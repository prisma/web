...
To use metrics in your project, you must enable the `metrics` feature flag in the `generator` block of your `schema.prisma` file. Learn more about how to [enable the feature flag in the Prisma schema file](/orm/v6/prisma-client/observability-and-logging/metrics#2-enable-the-feature-flag-in-the-prisma-schema-file).
