...
The global timeout of Accelerate has been exceeded. You can find the limit in [Can I increase my Accelerate query duration and response size limits?](/accelerate/more/faq#can-i-increase-my-accelerate-query-duration-and-response-size-limits).
...
The user supplied invalid parameters. Currently only relevant for transaction methods. For example, setting a timeout that is too high. You can find the limit in [Can I increase my Accelerate query duration and response size limits?](/accelerate/more/faq#can-i-increase-my-accelerate-query-duration-and-response-size-limits).
...
The global response size limit of Accelerate has been exceeded. You can find the limit in [Can I increase my Accelerate query duration and response size limits?](/accelerate/more/faq#can-i-increase-my-accelerate-query-duration-and-response-size-limits).
