...
| Argument              | Required | Description                                                                                                                                                 | Default |
| --------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| `--name` (or `-n`)    | No       | Enables targeting a specific database instance. Learn more about [using different local Prisma Postgres instances](/local-development/postgres#using-different-local-prisma-postgres-instances). |         |
