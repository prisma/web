...
Learn more about PostgreSQL connection strings in the [PostgreSQL](/orm/v6/overview/databases/postgresql) documentation.
...
Learn more about MySQL connection strings in the [MySQL/MariaDB](/orm/v6/overview/databases/mysql) documentation.
...
Learn more about MongoDB connection strings in the [Prisma ORM MongoDB database connector](/orm/v6/overview/databases/mongodb) documentation.
...
Learn more about SQLite connection strings in the [SQLite](/orm/v6/overview/databases/sqlite) documentation.
...
The format for connection strings is the same as for PostgreSQL. Learn more about PostgreSQL connection strings in the [PostgreSQL](/orm/v6/overview/databases/postgresql) documentation.
...
| `output`          | No       | String (file path)           | Determines the location for the generated client, learn more about [using a custom `output` path](/orm/v6/prisma-client/setup-and-configuration/generating-prisma-client#using-a-custom-output-path). **Default**: `node_modules/.prisma/client` |
...
| `output`                 | **Yes**  | String (file path)                                                                                                 | Determines the location for the generated client, learn more about [using a custom `output` path](/orm/v6/prisma-client/setup-and-configuration/generating-prisma-client#using-a-custom-output-path).                                                     |
| `previewFeatures`        | No       | List of Enums                                                                                                      | Use intellisense to see list of currently available Preview features (`Ctrl+Space` in Visual Studio Code) **Default**: none                                                                                                 |
...
- Prisma ORM has a number of **reserved words** that are being used by Prisma ORM internally and therefore cannot be used as a model name. You can find the reserved words in [the Prisma Client generator source](https://github.com/prisma/orm/blob/6.5.0/packages/client/src/generation/generateClient.ts#L556-L605) and in [the Prisma engines source](https://github.com/prisma/prisma-engines/blob/main/psl/parser-database/src/names/reserved_model_names.rs#L44).
...
Defines meta information about the relation. Learn more about [the `@relation` attribute](/orm/v6/prisma-schema/data-model/relations#the-relation-attribute).
...
For more information about using the `multiSchema` feature, refer to [Multi-schema](/orm/v6/prisma-schema/data-model/multi-schema).
