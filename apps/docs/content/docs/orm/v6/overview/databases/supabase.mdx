...
To learn more about Supabase, you can check out their architecture in [the Supabase architecture guide](https://supabase.com/docs/guides/getting-started/architecture) and features in [the Supabase feature overview](https://supabase.com/docs/guides/getting-started/features)
...
Supabase has a guide for connecting a Supabase database to your Prisma project in [Supabase's Prisma integration guide](https://supabase.com/partners/integrations/prisma).
