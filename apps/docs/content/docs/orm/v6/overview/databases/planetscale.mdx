...
Ensure you update the host value in your connection string to `aws.connect.psdb.cloud`. You can learn more about this in [the PlanetScale serverless driver tutorial](https://planetscale.com/docs/tutorials/planetscale-serverless-driver#add-and-use-the-planetscale-serverless-driver-for-javascript-to-your-project).
...
```npm
npm install @prisma/adapter-planetscale@6.19.3 undici
```
