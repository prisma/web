...
| Start clean (wipe local data first) | `npx prisma@next dev module.ts --fresh` (fails for apps with a database in this release; see [the reset steps](#whats-local-vs-whats-real)) |
