...
| You want to... | Run |
| --- | --- |
| Bring the app up locally | `npx prisma dev module.ts` |
| Start clean (wipe local data first) | `npx prisma dev module.ts --fresh` (fails for apps with a database in this release; see [the reset steps](#whats-local-vs-whats-real)) |
