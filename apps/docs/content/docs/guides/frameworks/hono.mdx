---
title: Hono
description: 'Build a Hono API on Prisma ORM with the hono template, add your own routes, and deploy it to Prisma Compute.'
url: /guides/frameworks/hono
metaTitle: How to use Prisma ORM with Hono
metaDescription: 'Scaffold a Hono API backed by Prisma ORM and Prisma Postgres, seed it, serve users over HTTP, add a POST route, and deploy to Prisma Compute.'
---
