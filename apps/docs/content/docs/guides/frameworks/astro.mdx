---
title: Astro
description: 'Set up Prisma ORM in an Astro app with create-prisma, from scaffold to rendered data, and deploy it to Prisma Compute.'
url: /guides/frameworks/astro
metaTitle: How to use Prisma ORM with Astro
metaDescription: 'Scaffold an Astro site with Prisma ORM and Prisma Postgres, seed the database, render your data, and deploy to Prisma Compute, with tested commands.'
---

## Introduction

This guide shows you how to use Prisma ORM in an Astro site. You scaffold a project that queries users during server rendering and exposes a JSON API route, initialize the schema, see your data render, and deploy the site to [Prisma Compute](/compute).
...
The scaffold generates the Astro app with Prisma ORM wired in, installs dependencies, and emits the contract your queries are type-checked against.
...
- `src/prisma/db.ts`: the Prisma ORM client both import
