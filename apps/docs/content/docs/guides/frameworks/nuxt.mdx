---
title: Nuxt
description: 'Set up Prisma ORM in a Nuxt app with create-prisma, from scaffold to rendered data, and deploy it to Prisma Compute.'
url: /guides/frameworks/nuxt
metaTitle: How to use Prisma ORM with Nuxt
metaDescription: 'Scaffold a Nuxt app with Prisma ORM and Prisma Postgres, initialize the database, render your data, and deploy to Prisma Compute.'
---

## Introduction

This guide shows you how to use Prisma ORM in a Nuxt app. You scaffold a project where a server API route queries your database and the page renders it, initialize the schema, see your data, and deploy the app to [Prisma Compute](/compute).
