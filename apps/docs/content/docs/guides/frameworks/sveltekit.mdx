---
title: SvelteKit
description: 'Set up Prisma ORM in a SvelteKit app with create-prisma, from scaffold to rendered data.'
url: /guides/frameworks/sveltekit
metaTitle: How to use Prisma ORM with SvelteKit
metaDescription: 'Scaffold a SvelteKit project with Prisma ORM and Prisma Postgres, initialize the database, seed it, and see your data, with tested commands.'
---

## Introduction

This guide shows you how to use Prisma ORM in a SvelteKit app. You scaffold a project where a server load function queries your database, initialize the schema, and see your data render.
...
The scaffold generates the SvelteKit app with Prisma ORM wired in, installs dependencies, and emits the contract your queries are type-checked against.
...
- `src/prisma/db.ts`: the Prisma ORM client behind that helper
