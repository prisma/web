---
title: Bun
description: 'Scaffold a Prisma ORM app with Bun, run your first typed query, serve users over HTTP, and deploy to Prisma Compute.'
url: /guides/runtimes/bun
metaTitle: How to use Prisma ORM with Bun
metaDescription: 'Set up a Prisma ORM project with Bun and Prisma Postgres, from scaffold to first typed query, then serve users over HTTP and deploy to Prisma Compute.'
---
