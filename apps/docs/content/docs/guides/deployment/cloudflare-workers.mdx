...
- Use [Hono](https://hono.dev/) for a more robust routing framework with Cloudflare Workers (see our [Hono guide](/guides/v7/frameworks/hono))
...
- [Deploy to Cloudflare](/orm/v7/prisma-client/deployment/edge/deploy-to-cloudflare) — deeper reference on edge deployment options
