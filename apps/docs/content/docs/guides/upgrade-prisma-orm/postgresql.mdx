...
This guide targets `prisma@latest` (the Prisma 8 CLI, `8.0.0-rc.13` at the time of writing; its release line is separate from the ORM packages'), `@prisma/orm-postgres@8.0.0-rc.9`, `@prisma/cli-engine@0.3.0`, and `@prisma/prisma7@7.10.0-dev.58`, with a Prisma 7 baseline on `7.9.1`.
