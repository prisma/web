...
Prisma ORM MongoDB support evolves quickly, so check anything below against the `@prisma/orm-*` version you install. This guide targets `@prisma/orm-mongo@8.0.0-rc.11`.
