...
- To deploy **your own app** that uses Prisma ORM, see the [Next.js guide](/guides/frameworks/nextjs) for Prisma ORM 8, or [Deploy to Vercel](/orm/v7/prisma-client/deployment/serverless/deploy-to-vercel) for Prisma ORM 7.
