...
The scaffold writes your connection string to `.env`, generates the Astro app with Prisma 8 wired in, installs dependencies, and emits the contract your queries are type-checked against.
