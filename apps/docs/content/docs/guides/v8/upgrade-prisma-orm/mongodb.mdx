...
npx prisma@next db migrate --db "$DATABASE_URL" --advance-ref db
...
See the [Prisma 8 docs](/orm/v8) for [pipeline builder patterns](/orm/v8/reference/pipeline-builder), [relation loading strategies](/orm/v8/reference/orm-client), and [advanced contract features](/orm/v8/contract-authoring/psl-syntax). This guide gets you across the bridge. From here on, Prisma 8's docs are the source of truth.
