...
4. Add a POST /users route that creates a user from the request body, following https://www.prisma.io/docs/guides/next/frameworks/hono.md, and verify it with curl.
