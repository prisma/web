...
3. Do not deploy to Prisma Compute; it does not support SvelteKit yet. Start `npm run dev` and verify http://localhost:5173 lists the three seeded users, following https://www.prisma.io/docs/guides/next/frameworks/sveltekit.md.
