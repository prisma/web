...
3. Start `npm run dev` and verify http://localhost:5173 lists the three seeded users, following https://www.prisma.io/docs/guides/next/frameworks/sveltekit.md.
