...
For an optimal development experience when working with Prisma ORM, refer to [editor setup](/orm/v7/more/dev-environment/editor-setup) to learn about syntax highlighting, formatting, auto-completion, and many more cool features.
