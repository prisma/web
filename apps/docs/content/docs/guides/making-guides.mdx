...
Prisma ORM 8 is the current release. Prisma ORM 7 remains fully supported; the Prisma 7 version of this guide is at [/guides/v7/[category]/[slug]](/guides/v7/[category]/[slug]).
