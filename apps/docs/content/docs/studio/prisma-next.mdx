...
Open the URL the command prints; the seeded users come back through the Prisma ORM client. Then stop the dev server. See [Writing data](/orm/fundamentals/writing-data) for the query API.
