...
- Reading the applied migration history of a [Prisma Next](/orm/next) database
...
- [Studio with Prisma Next](/studio/prisma-next) - Apply migrations to Prisma Postgres and read your migration history in the Migrations view
