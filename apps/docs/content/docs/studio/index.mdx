...
- Reading the applied migration history of a [Prisma ORM](/orm) database
...
- [Studio with Prisma ORM](/studio/prisma-next) - Apply migrations to Prisma Postgres and read your migration history in the Migrations view
