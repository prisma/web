...
This is also how you launch Studio for a [Prisma Next](/orm/next) project, which has no `schema.prisma` to read. See [Studio with Prisma Next](/studio/prisma-next).
...
- Use Studio with a [Prisma Next project](/studio/prisma-next) to read your applied migration history in the Migrations view
