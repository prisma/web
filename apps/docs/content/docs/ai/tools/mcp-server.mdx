...
Composer defines your application's services, databases, and other resources in TypeScript.
...
The Prisma MCP server uses Streamable HTTP at `https://mcp.prisma.io/mcp`. Add it using your AI tool's MCP settings. For tools that accept a JSON configuration, use:
