...
- List automated backups and restore them into new databases.
- Create and manage connection strings.
- Execute SQL queries.
- Introspect database schemas.
- Manage Prisma Compute deployments, read app logs, and set environment variables.
- Manage Object Storage buckets and access keys.
